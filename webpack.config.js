        ...
        plugins: [
            ...
            new FriendlyErrorsWebpackPlugin({
                compilationSuccessInfo: {
                    messages: [`🔥 ${settings.name} is running at '${settings.devServerUrl}'`],
                },
            ...
            new HtmlWebpackPlugin({
                filename: 'index.html',
                template: path.resolve(__dirname, settings.templates, `./index.twig`)
            }),
            new HtmlWebpackPlugin({
                filename: 'introduction.html',
                template: path.resolve(__dirname, settings.templates, `./introduction.twig`)
            }),
